...
public class DatabaseUtils
{
	...
	*/
	...
	public void createAccount(Player player)
	{
		...
		// MultiThread uniquement si c'est vrmt des grosses requetes SQL, inutile si
		// elles sont petites
	}
	...
	/**
	 * * Met à jour la valeur d'une colonne spécifique pour une entrée dans la base
	 * de données. Cette méthode construit et exécute une requête SQL de mise à jour
	 * pour modifier la valeur d'une colonne donnée où une condition spécifique est
	 * remplie.
	 * 
	 ...
	 * @param table_name    Le nom de la table dans la base de données où la mise à
	 *                      jour doit être appliquée.
	 * @param where         Le nom de la colonne utilisée pour identifier les
	 *                      enregistrements à mettre à jour.
	 * @param whereFinding  La valeur de la colonne utilisée pour identifier les
	 *                      enregistrements à mettre à jour. Exemple : set("money",
	 *                      "100", "users_informations", "uuid",
	 ...
	 * @param whereFinding La valeur spécifique de la colonne 'where' utilisée pour
	 *                     filtrer les enregistrements.
	 * @return String 	   La valeur de la colonne demandée pour le premier
	 *         			   enregistrement correspondant aux critères de recherche. Retourne null
	 *         			   si aucun enregistrement correspondant n'est trouvé ou en cas d'erreur
	 *         			   SQL. Retourne la valeur de la colonne demandée pour le premier
	 *        			   enregistrement correspondant aux critères de recherche.
	 */
	 ...
	 * @param whereFinding La valeur spécifique de la colonne 'where' utilisée pour
	 *                     filtrer les enregistrements.
	 * @return boolean La valeur de la colonne demandée pour le premier
	 *         enregistrement correspondant aux critères de recherche. Retourne
	 *         false si aucun enregistrement correspondant n'est trouvé ou en cas
	 *         d'erreur SQL. Retourne la valeur de la colonne demandée pour le
	 *         premier enregistrement correspondant aux critères de recherche.
	 */
	 ...
	 * @param whereFinding La valeur spécifique de la colonne 'where' utilisée pour
	 *                     filtrer les enregistrements.
	 * @return int La valeur de la colonne demandée pour le premier enregistrement
	 *         correspondant aux critères de recherche. Retourne 0 si aucun
	 *         enregistrement correspondant n'est trouvé ou en cas d'erreur SQL.
	 *         Retourne la valeur de la colonne demandée pour le premier
	 *         enregistrement correspondant aux critères de recherche.
	 */
	 ...
	 * @param whereFinding La valeur spécifique de la colonne 'where' utilisée pour
	 *                     filtrer les enregistrements.
	 * @return float La valeur de la colonne demandée pour le premier enregistrement
	 *         correspondant aux critères de recherche. Retourne 0.0F si aucun
	 *         enregistrement correspondant n'est trouvé ou en cas d'erreur SQL.
	 *         Retourne la valeur de la colonne demandée pour le premier
	 *         enregistrement correspondant aux critères de recherche.
	 */
	...
	private Connection getConnection()
	{
		try
		{
			return DatabaseManager.EDMINE.getDatabaseAccess().getConnection();
		}
		catch (SQLException exeption)
		{
			System.out.println("Un problème est survenu lors de la tentative de connexion à la base de donnée");
			exeption.printStackTrace();
		}
		return null;
	}
	
	public PreparedStatement getPreparedStatement(String table_name, String where) throws SQLException
	{
		return getConnection().prepareStatement("SELECT * FROM " + table_name + " WHERE " + where + " = ?");
	}
}
