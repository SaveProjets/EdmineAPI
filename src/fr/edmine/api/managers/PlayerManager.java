...
public class PlayerManager
{
	 ...
	 */
	public PlayerManager(Player player, RankList rank, StaffRankList staffRank, int soul_fragment, int divine_radiance, int money, int level, String guild)
	{
		this.rank 				= rank;
	 ...
	 * @param guild           guild du joueur
	 */
	public PlayerManager(ProxiedPlayer player, RankList rank, StaffRankList staffRank, int soul_fragment, int divine_radiance, int money, int level, String guild)
	{
		this.rank 				= rank;
		this.staffRank 			= staffRank;
		this.soul_fragment 		= soul_fragment;
	 ...
	 * @param guild           guild du joueur
	 */
	public PlayerManager(UUID uuid, RankList rank, StaffRankList staffRank, int soul_fragment, int divine_radiance, int money, int level, String guild)
	{
		this.rank 				= rank;
		this.staffRank 			= staffRank;
		this.soul_fragment 		= soul_fragment;
	 ...
	 * @return PlayerManager
	 */
	public static PlayerManager getPlayer(ProxiedPlayer player)
	{
		return players.get(player);
	}
